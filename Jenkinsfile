    ...
    stages {
        stage('PLAY ANSIBLE BOOK.') {
             steps {
                ...
                sh 'ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook --u $username --private-key $password ansible/playbook/playbook.yml -i ansible/inventory/hosts/ec2.py -vvvvv' 
